-module(raft).
-export([start_raft_member/1,start_raft_members/1,append_log/3,make_leader/1, raft_peer/1]).
...
% You can of course store it as a tuple, but updating that tuples
